...
//*   		This is my Submission for the CalebJonesICE04 
//*  
//*  							 :)
//*                         Date Created 
//*  						(Feb 28, 2023)
//*                         File Name:  WaterBillMain.java
//*  							
//****************************************************************************
package ICE4;
...
public class WaterBillMain {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		int fileSize = getFileLength("inputWaterBill.txt");
	...
	private static void addCustomer(String custName, int custNumber, int g, int type) {
	    ...
	    WaterBill b = new WaterBill(g,type);
	    Customer cust = new Customer(custName,custNumber,b);
		customers[Customer.getNoOfCustObjects()] = cust;
	}//end addCustomer
	...
	public static void displayBill() {
              ...
              // Use the for loop to read Customer data from the customers array, use method toString()
               for(int i = 0; i < customers[i].length-1;i++) {
	...
	// reads the number of lines in the input data file - returns int value
		public static int getFileLength(String fileName) throws FileNotFoundException {
		   ...
		   // Start reading data from file using while loop
		    int i = 0;
		    while (sc.hasNext()) {
	          // To Complete - Read the file data line by line, then count the number of lines using i
		    	sc.nextLine();
		    	i++;
